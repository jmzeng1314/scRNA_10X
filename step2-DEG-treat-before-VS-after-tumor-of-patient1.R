...
if(F){
  ...
  Sys.time()
  # 可以看到运行耗时
  # 从 2019-07-22 15:12:54 到 2019-07-22 15:23:04
  save(diff_test_res,file='patient1.tumor_diff_test_res.Rdata')
}


load(file = 'patient1.tumor_diff_test_res.Rdata')
...
dim(count_matrix)
table(cluster)
htmapGenes='PCNA,SMC2,CCNI,CCNA1,NCL,BRIX1,MDH2,VIP,CHGA,NEFM,CD44,LGALS7B,HLA-B,HLA-E,B2M'
